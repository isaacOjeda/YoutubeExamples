...
export interface IClient {
    ...
    createProduct(createProductCommand: CreateProductCommand): Observable<void>;
    updateProduct(updateProductCommand: UpdateProductCommand): Observable<void>;
    deleteProduct(productId: number): Observable<void>;
    updatePrice(updatePriceCommand: UpdatePriceCommand): Observable<void>;
...
export class Client implements IClient {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<GetProductsResponse[]>><any>_observableThrow(e);
                }
            } else
                return <Observable<GetProductsResponse[]>><any>_observableThrow(response_);
        }));
    }
    ...
    protected processGetProducts(response: HttpResponseBase): Observable<GetProductsResponse[]> {
        ...
        return _observableOf<GetProductsResponse[]>(<any>null);
    }
    ...
    updatePrice(updatePriceCommand: UpdatePriceCommand) : Observable<void> {
        let url_ = this.baseUrl + "/api/products/price";
        url_ = url_.replace(/[?&]$/, "");

        const content_ = JSON.stringify(updatePriceCommand);
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<GetCategoriesResponse[]>><any>_observableThrow(e);
                }
            } else
                return <Observable<GetCategoriesResponse[]>><any>_observableThrow(response_);
        }));
    }
    ...
    protected processGetCategories(response: HttpResponseBase): Observable<GetCategoriesResponse[]> {
        ...
        return _observableOf<GetCategoriesResponse[]>(<any>null);
    }
}
