...
namespace MyFirstApi.Client
{
    ...
    public partial class ProductsClient 
    {
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task UpdateProductAsync(int? productId, string name, string description, double? price, int? categoryId, string categoryName, FileParameter photo)
        {
            return UpdateProductAsync(productId, name, description, price, categoryId, categoryName, photo, System.Threading.CancellationToken.None);
        }
    
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task UpdateProductAsync(int? productId, string name, string description, double? price, int? categoryId, string categoryName, FileParameter photo, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/Products");
